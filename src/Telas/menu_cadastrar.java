...
public class menu_cadastrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bt_usuario.setBackground(new java.awt.Color(51, 140, 233));
        bt_usuario.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        bt_usuario.setForeground(new java.awt.Color(255, 255, 255));
        bt_usuario.setText("USUÁRIOS");
        bt_usuario.setToolTipText("Clique para cadastrar usuários do sistema");
        bt_usuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_usuarioActionPerformed(evt);
            }
        });
        jPanel1.add(bt_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 140, 40));
    ...
    private void bt_profActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_profActionPerformed
        Cadastro_professores menu = new Cadastro_professores(usuarioLogado);
    ...
    private void bt_alunosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_alunosActionPerformed
        Cadastro_aluno menu = new Cadastro_aluno(usuarioLogado);
        menu.setVisible(true);
        dispose();
    ...
    private void bt_usuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_usuarioActionPerformed
        Cadastro_usuario menu = new Cadastro_usuario(usuarioLogado);
        menu.setVisible(true);
        dispose();
